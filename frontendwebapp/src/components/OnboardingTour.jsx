...
const steps = [
  ...
  {
    title: "Bank Module",
    body: "Click **Bank** in the top nav. Record income and every expense — the app keeps a running net balance for you.",
  ...
  },
  {
    ...
    body: "Click the **Amount** field. Type any positive number — income stays positive, expenses are saved with the correct sign automatically based on category.",
  ...
  {
    title: "Share Module",
    body: "Click **Share** to track IPO allotments, secondary market buys/sells, and dividends. The app calculates profit/loss per trade.",
  ...
  {
    title: "Summary View",
    body: "Click **Summary** to see bank totals, share investment, dividends, and your overall net financial position — all in one place.",
