(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e;(function(e){e.Unimplemented=`UNIMPLEMENTED`,e.Unavailable=`UNAVAILABLE`})(e||={});var t=class extends Error{constructor(e,t,n){super(e),this.message=e,this.code=t,this.data=n}},n=e=>e?.androidBridge?`android`:e?.webkit?.messageHandlers?.bridge?`ios`:`web`,r=r=>{let i=r.CapacitorCustomPlatform||null,a=r.Capacitor||{},o=a.Plugins=a.Plugins||{},s=()=>i===null?n(r):i.name,c=()=>s()!==`web`,l=e=>!!(f.get(e)?.platforms.has(s())||u(e)),u=e=>a.PluginHeaders?.find(t=>t.name===e),d=e=>r.console.error(e),f=new Map;return a.convertFileSrc||=e=>e,a.getPlatform=s,a.handleError=d,a.isNativePlatform=c,a.isPluginAvailable=l,a.registerPlugin=(n,r={})=>{let c=f.get(n);if(c)return console.warn(`Capacitor plugin "${n}" already registered. Cannot register plugins twice.`),c.proxy;let l=s(),d=u(n),p,m=async()=>(!p&&l in r?p=p=typeof r[l]==`function`?await r[l]():r[l]:i!==null&&!p&&`web`in r&&(p=p=typeof r.web==`function`?await r.web():r.web),p),ee=(r,i)=>{if(d){let e=d?.methods.find(e=>i===e.name);if(e)return e.rtype===`promise`?e=>a.nativePromise(n,i.toString(),e):(e,t)=>a.nativeCallback(n,i.toString(),e,t);if(r)return r[i]?.bind(r)}else if(r)return r[i]?.bind(r);else throw new t(`"${n}" plugin is not implemented on ${l}`,e.Unimplemented)},h=r=>{let i,a=(...a)=>{let o=m().then(o=>{let s=ee(o,r);if(s){let e=s(...a);return i=e?.remove,e}throw new t(`"${n}.${r}()" is not implemented on ${l}`,e.Unimplemented)});return r===`addListener`&&(o.remove=async()=>i()),o};return a.toString=()=>`${r.toString()}() { [capacitor code] }`,Object.defineProperty(a,"name",{value:r,writable:!1,configurable:!1}),a},g=h(`addListener`),_=h(`removeListener`),v=(e,t)=>{let n=g({eventName:e},t),r=async()=>{let r=await n;_({eventName:e,callbackId:r},t)},i=new Promise(e=>n.then(()=>e({remove:r})));return i.remove=async()=>{console.warn(`Using addListener() without 'await' is deprecated.`),await r()},i},y=new Proxy({},{get(e,t){switch(t){case`$$typeof`:return;case`toJSON`:return()=>({});case`addListener`:return d?v:g;case`removeListener`:return _;default:return h(t)}}});return o[n]=y,f.set(n,{name:n,proxy:y,platforms:new Set([...Object.keys(r),...d?[l]:[]])}),y},a.Exception=t,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},i=(e=>e.Capacitor=r(e))(typeof globalThis<`u`?globalThis:typeof self<`u`?self:typeof window<`u`?window:typeof global<`u`?global:{}),a=i.registerPlugin,o=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(t);let r=this.windowListeners[e];return r&&!r.registered&&this.addWindowListener(r),n&&this.sendRetainedArgumentsForEvent(e),Promise.resolve({remove:async()=>this.removeListener(e,t)})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,n){let r=this.listeners[e];if(!r){if(n){let n=this.retainedEventArguments[e];n||=[],n.push(t),this.retainedEventArguments[e]=n}return}r.forEach(e=>e(t))}hasListeners(e){return!!this.listeners[e]?.length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:e=>{this.notifyListeners(t,e)}}}unimplemented(t=`not implemented`){return new i.Exception(t,e.Unimplemented)}unavailable(t=`not available`){return new i.Exception(t,e.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let r=n.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(t=>{this.notifyListeners(e,t)}))}},s=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),c=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),l=class extends o{async getCookies(){let e=document.cookie,t={};return e.split(`;`).forEach(e=>{if(e.length<=0)return;let[n,r]=e.replace(/=/,`CAP_COOKIE`).split(`CAP_COOKIE`);n=c(n).trim(),r=c(r).trim(),t[n]=r}),t}async setCookie(e){try{let t=s(e.key),n=s(e.value),r=e.expires?`; expires=${e.expires.replace(`expires=`,``)}`:``,i=(e.path||`/`).replace(`path=`,``),a=e.url!=null&&e.url.length>0?`domain=${e.url}`:``;document.cookie=`${t}=${n||``}${r}; path=${i}; ${a};`}catch(e){return Promise.reject(e)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(e){return Promise.reject(e)}}async clearCookies(){try{let e=document.cookie.split(`;`)||[];for(let t of e)document.cookie=t.replace(/^ +/,``).replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}};a(`CapacitorCookies`,{web:()=>new l});var u=async e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{let e=r.result;t(e.indexOf(`,`)>=0?e.split(`,`)[1]:e)},r.onerror=e=>n(e),r.readAsDataURL(e)}),d=(e={})=>{let t=Object.keys(e);return Object.keys(e).map(e=>e.toLocaleLowerCase()).reduce((n,r,i)=>(n[r]=e[t[i]],n),{})},f=(e,t=!0)=>e?Object.entries(e).reduce((e,n)=>{let[r,i]=n,a,o;return Array.isArray(i)?(o=``,i.forEach(e=>{a=t?encodeURIComponent(e):e,o+=`${r}=${a}&`}),o.slice(0,-1)):(a=t?encodeURIComponent(i):i,o=`${r}=${a}`),`${e}&${o}`},``).substr(1):null,p=(e,t={})=>{let n=Object.assign({method:e.method||`GET`,headers:e.headers},t),r=d(e.headers)[`content-type`]||``;if(typeof e.data==`string`)n.body=e.data;else if(r.includes(`application/x-www-form-urlencoded`)){let t=new URLSearchParams;for(let[n,r]of Object.entries(e.data||{}))t.set(n,r);n.body=t.toString()}else if(r.includes(`multipart/form-data`)||e.data instanceof FormData){let t=new FormData;if(e.data instanceof FormData)e.data.forEach((e,n)=>{t.append(n,e)});else for(let n of Object.keys(e.data))t.append(n,e.data[n]);n.body=t;let r=new Headers(n.headers);r.delete(`content-type`),n.headers=r}else(r.includes(`application/json`)||typeof e.data==`object`)&&(n.body=JSON.stringify(e.data));return n},m=class extends o{async request(e){let t=p(e,e.webFetchExtra),n=f(e.params,e.shouldEncodeUrlParams),r=n?`${e.url}?${n}`:e.url,i=await fetch(r,t),a=i.headers.get(`content-type`)||``,{responseType:o=`text`}=i.ok?e:{};a.includes(`application/json`)&&(o=`json`);let s,c;switch(o){case`arraybuffer`:case`blob`:c=await i.blob(),s=await u(c);break;case`json`:s=await i.json();break;default:s=await i.text()}let l={};return i.headers.forEach((e,t)=>{l[t]=e}),{data:s,headers:l,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:`GET`}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:`POST`}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:`PUT`}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:`PATCH`}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:`DELETE`}))}};a(`CapacitorHttp`,{web:()=>new m});var ee=`modulepreload`,h=function(e){return`/`+e},g={},_=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=h(t,n),t=s(t),t in g)return;g[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:ee,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},v=a(`App`,{web:()=>_(()=>import(`./web-ByaLl_9p.js`).then(e=>new e.AppWeb),[])});function y(){return new Date}function b(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function x(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t,n-1,r)}function S(e,t){let n=new Date(e);return n.setDate(n.getDate()+t),n}function te(e,t){let n=x(e).getTime(),r=x(t).getTime();return Math.floor((r-n)/864e5)+1}function C(e){return b(e).slice(0,7)}function ne(e){return e.toLocaleString(`en-US`,{month:`long`})}var re=`mobile-local`,ie=`mobile-v1.0.0`,ae=`finledge.mobile.profileName`,w=`finledge.mobile.profilePromptDismissed`,T={activeScreen:`home`,screenHistory:[`home`],lastHomeBackPress:0,homeMode:`expense`,homeRange:`week`,bankRange:`month`,selectedHomeCategories:new Set,categorySelectionTouched:!1,customStart:b(new Date(y().getFullYear(),y().getMonth(),1)),customEnd:b(y()),dashSearchQuery:{bank:``,shares:``,expenses:``},expensesDashTab:`combined`,sharesEntryType:`ipo`};function oe(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function E(){return window.localStorage.getItem(ae)?.trim()||``}function se(){return(E()||`F`).slice(0,1).toUpperCase()}function ce(){return!E()&&!window.localStorage.getItem(w)}function le(e){let t=e.trim();t&&(window.localStorage.setItem(ae,t),window.localStorage.setItem(w,`1`))}function ue(){window.localStorage.setItem(w,`1`)}function de(e){document.querySelector(`.toast`)?.remove();let t=document.createElement(`div`);t.className=`toast`,t.textContent=e,document.body.appendChild(t),window.setTimeout(()=>t.remove(),1600)}function fe(){v.exitApp()}var pe=[`Interest Earned`,`Interest Tax`,`Mobile Banking Charge`,`Debit Card Charge`,`Cheque Book`,`Locker`,`Demat Renewal`,`Demat & MeroShare Renewal`,`Broker Renewal`,`MeroShare Renewal`,`Other Charges`],me=[`ipo`,`sip`,`buy`,`sell`,`dividend`],he={ipo:`IPO entry`,sip:`SIP investment`,buy:`Secondary buy`,sell:`Sell shares`,dividend:`Dividend`},ge=[{value:`bank`,label:`Bank Flow`},{value:`cash`,label:`Cash Flow`}],_e=[{value:`expense`,label:`Expense`},{value:`income`,label:`Income`}],ve=[`Food`,`Transportation`,`Entertainment`,`Shopping`,`Health`,`Education`,`Bills`,`Rent`,`Travel`,`Insurance`,`Investment`,`SIP`,`Share Market`,`Other`],ye=[`Salary`,`Freelance`,`Business`,`Prize/Lottery`,`Gift`,`Refund`,`Investment Income`,`Investment Return`,`Dividend`,`Share Sell Proceeds`,`Other Income`];function D(e,t={}){let n=Math.abs(e).toLocaleString(`en-US`,{maximumFractionDigits:2});return t.sign?`${e>=0?`+`:`-`}Rs ${n}`:`Rs ${n}`}function O(e){let t=e<0?`-`:``,n=Math.abs(e);return n>=1e5?`${t}${(n/1e5).toFixed(n%1e5==0?0:1)}L`:n>=1e3?`${t}${(n/1e3).toFixed(n%1e3==0?0:1)}k`:`${t}${n.toLocaleString(`en-US`,{maximumFractionDigits:0})}`}var k=`var(--accent-green)`,A=`var(--accent-red)`,be=`var(--brand-teal)`,xe=`var(--accent-amber)`,Se=64,Ce=104;function we(e){let t=Ae(e);return typeof t==`string`?`<p class="sub range-warning">${t}</p>`:`${j(t)}${Te()}`}function j(e){if(!e.length)return`<p class='sub'>No data for this period.</p>`;let t=Math.max(...e.flatMap(e=>[e.income,e.expense,Math.abs(e.net)]),1);return`
  ...
  `}function Te(){return`<div class="chart-legend" style="margin-top:10px;display:flex;flex-wrap:wrap;gap:10px;">
    ...
    </div>`}function Ee(e,t){let n=e.net>=0?be:xe,r=[{value:e.income,color:k,show:e.income>0,label:O(e.income)},{value:e.expense,color:A,show:e.expense>0,label:O(e.expense)},{value:Math.abs(e.net),color:n,show:e.net!==0,label:O(e.net)}];return`<div class="grouped-bar-col" style="width:${Se}px;">
    <div class="grouped-bar-values">${r.map(e=>De(e.label,e.color,e.show)).join(``)}</div>
    <div class="grouped-bar-sticks">${r.map(e=>Oe(e.value,t,e.color,e.show)).join(``)}</div>
    <span class="grouped-bar-x">${e.label}</span>
    <span class="grouped-bar-sub">${e.sublabel??``}</span>
  </div>`}function De(e,t,n){return n?`<span class="grouped-bar-val" style="color:${t};" title="${e}">${e}</span>`:`<span class="grouped-bar-val grouped-bar-val-empty"></span>`}function Oe(e,t,n,r){return!r||Math.abs(e)<.01?`<div class="grouped-bar-body grouped-bar-body-empty"></div>`:`<div class="grouped-bar-body" style="height:${Math.max(6,Math.abs(e)/t*Ce)}px;background:${n};"></div>`}function ke(e){let t=new Map;for(let n of e){let e=String(n.category??`Other`);t.set(e,(t.get(e)??0)+Number(n.amount??0))}let n=[...t.entries()].sort((e,t)=>t[1]-e[1]).slice(0,5);if(!n.length)return`<p class="sub">Nothing to show for the selected ${T.homeMode} categories yet.</p>`;let r=Math.max(...n.map(([,e])=>e),1),i=T.homeMode===`income`?`pos`:`neg`,a=T.homeMode===`income`?k:A;return n.map(([e,t])=>`<div class="history-row"><b>${e}</b><span class="money ${i}">${O(t)}</span></div>
     <div class="category-meter"><i style="width:${Math.max(8,t/r*100)}%;background:${a};"></i></div>`).join(``)}function Ae(e){let t=y();if(T.homeRange===`week`)return M(e,S(t,-89),t);if(T.homeRange===`month`)return M(e,S(t,-399),t);if(T.homeRange===`year`)return je(e,48);let n=te(T.customStart,T.customEnd);return n<1?`Choose an end date after the start date.`:n>365?`Custom range supports up to 365 days.`:M(e,x(T.customStart),x(T.customEnd))}function M(e,t,n){let r=new Map;for(let e=new Date(t);e<=n;e=S(e,1)){let t=b(e),n=e.toLocaleString(`en-US`,{month:`short`});r.set(t,{label:String(e.getDate()),sublabel:n,key:t,income:0,expense:0,net:0})}for(let t of e){let e=r.get(String(t.date));e&&Me(e,t)}return[...r.values()]}function je(e,t){let n=y();return Array.from({length:t},(r,i)=>{let a=new Date(n.getFullYear(),n.getMonth()-(t-1-i),1),o=C(a),s=String(a.getFullYear()).slice(2),c={label:a.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${s}`,key:o,income:0,expense:0,net:0};for(let t of e)String(t.date).startsWith(o)&&Me(c,t);return c})}function Me(e,t){let n=Number(t.amount||0);t.direction===`income`?(e.income+=n,e.net+=n):(e.expense+=n,e.net-=n)}var Ne=b(y());function N(e,t){return`<main class="screen ${T.activeScreen===e?`active`:``}" data-screen="${e}">${t}</main>`}function Pe(){let e=E();return`
    <header class="topbar">
  ...
  `}function P(e,t){let n=[`<button class="btn-secondary" type="button" data-back="${e}">Back</button>`,`<button class="btn-secondary" type="button" data-nav="home">Home</button>`];if(t){let e=t.endsWith(`dash`)?`View dashboard`:`Add entry`;n.push(`<button class="btn-secondary" type="button" data-nav="${t}">${e}</button>`)}return`<div class="btn-row ${t?`btn-row-3`:`btn-row-2`}">${n.join(``)}</div>`}function Ie(e,t,n,r,i){return`<p class="eyebrow">${e}</p><h1 class="pagehead">${t}</h1><p class="sub">Stored locally on this device.</p>${Le(n,r)}${P(`home`,i)}`}function Le(e,t){return`<section class="card">${e.map(([e,t,n])=>F(e,t,n)).join(``)}<button class="btn-primary">${t}</button></section>`}function F(e,t,n){return t===`select`?`<div class="field"><label>${e}</label><select>${Re(e,n)}</select></div>`:`<div class="field"><label>${e}</label><input type="${t}" ${t===`number`?`inputmode="decimal"`:``} value="${t===`date`?Ne:n??``}"></div>`}function Re(e,t=`Other`){return({Category:pe.includes(t??``)?pe:[...ve,...ye],"Entry type":me,Flow:ge.map(e=>e.label),Type:_e.map(e=>e.label),"Dividend Type":[`cash`,`bonus`],"SIP type":[`installment`,`redeem`]}[e]||[t??`Other`,`Other`]).map(e=>`<option value="${e}">${he[e]||e}</option>`).join(``)}function I(e,t=``){return`<div class="section-title"><h3>${e}</h3>${t?`<span>${t}</span>`:``}</div>`}function L(e,t=`Search`){return`<input class="search-input" type="search" placeholder="${t}" value="${(T.dashSearchQuery[e]??``).replace(/"/g,`&quot;`)}" data-search-module="${e}" autocomplete="off">`}function R(e,t=2,n=!1){return`<div class="${t===3?`stat-grid split-3`:`stat-grid`}">${e.map(([t,r,i],a)=>{let o=a===e.length-1;return`<div class="stat-box${n&&o?` stat-box-full`:``}"><div class="label">${t}</div><div class="value money ${i}">${D(r,{sign:i===`pos`||i===`neg`})}</div></div>`}).join(``)}</div>`}function z(e=T.homeRange,t=!1){let n=y();if(t&&e===`week`&&(e=`month`),e===`week`&&!t)return Array.from({length:90},(e,t)=>{let r=S(n,t-89);return{label:String(r.getDate()),sublabel:r.toLocaleString(`en-US`,{month:`short`}),key:b(r),isDay:!0}});if(e===`month`)return t?Array.from({length:13},(e,t)=>{let r=new Date(n.getFullYear(),n.getMonth()-(12-t),1),i=String(r.getFullYear()).slice(2);return{label:r.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${i}`,key:C(r),isDay:!1}}):Array.from({length:400},(e,t)=>{let r=S(n,t-399);return{label:String(r.getDate()),sublabel:r.toLocaleString(`en-US`,{month:`short`}),key:b(r),isDay:!0}});if(e===`year`)return Array.from({length:48},(e,t)=>{let r=new Date(n.getFullYear(),n.getMonth()-(47-t),1),i=String(r.getFullYear()).slice(2);return{label:r.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${i}`,key:C(r),isDay:!1}});if(e!==`custom`)return[];let r=te(T.customStart,T.customEnd);if(r<=60)return Array.from({length:r},(e,t)=>{let n=S(x(T.customStart),t);return{label:String(n.getDate()),sublabel:n.toLocaleString(`en-US`,{month:`short`}),key:b(n),isDay:!0}});let i=[],a=new Date(x(T.customStart));a.setDate(1);let o=x(T.customEnd);for(;a<=o;){let e=String(a.getFullYear()).slice(2);i.push({label:a.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${e}`,key:C(a),isDay:!1}),a=new Date(a.getFullYear(),a.getMonth()+1,1)}return i}var ze=44,Be=14,B=12,V=18,Ve=112;function He(e){if(!e.length)return`<p class='sub'>No data for this period.</p>`;let t=e.filter(e=>Math.abs(e.value)>0),n=t.length?Math.max(...t.map(e=>Math.abs(e.value))):1;e.length*50;let r=e.map(e=>{let t=Math.abs(e.value)>=.01,r=t?Math.max(6,Math.abs(e.value)/n*Ve):0;return`<div class="single-bar-col" style="width:${ze}px;">${t?`<span style="height:${V}px;font-size:9px;font-weight:700;color:${e.color};font-variant-numeric:tabular-nums;white-space:nowrap;">${O(e.value)}</span>`:`<span style="height:${V}px;"></span>`}${t?`<div style="height:${r}px;width:18px;background:${e.color};border-radius:4px 4px 2px 2px;flex-shrink:0;"></div>`:`<div style="height:0;"></div>`}${`<span style="height:${Be}px;font-size:9px;color:var(--text-2);font-weight:500;">${e.label}</span>`}${e.sublabel?`<span style="height:${B}px;font-size:8px;color:var(--text-3);">${e.sublabel}</span>`:`<span style="height:${B}px;"></span>`}</div>`}).join(``);return`<div class="chart-scroll chart-animate" data-scroll-end style="-webkit-overflow-scrolling:touch;">
    <div class="chart-track" style="width:${Ue(e)}px;">
      ${r}
    </div>
  </div>`}function Ue(e){return e.length*50+16}function We({ranges:e=[`week`,`month`,`year`,`custom`],activeRange:t=T.homeRange,rangeAttr:n=`data-home-range`}={}){return`<div class="segmented graph-tabs period-tabs" style="margin-bottom:8px;">${e.map(e=>`<button class="${t===e?`active`:``}" ${n}="${e}">${e[0].toUpperCase()}${e.slice(1)}</button>`).join(``)}</div>${t===`custom`?`<div class="custom-range"><label>From<input type="date" value="${T.customStart}" data-custom-start></label><label>To<input type="date" value="${T.customEnd}" data-custom-end></label></div>`:``}`}function H(e,t,n,r={}){let i=n.map(e=>`<span><i style="display:inline-block;width:10px;height:10px;border-radius:3px;background:${e.color};margin-right:5px;vertical-align:middle;"></i>${e.label}</span>`).join(``);return`<section class="card">
    ...
    ${T.homeRange===`custom`?`<div class="custom-range"><label>From<input type="date" value="${T.customStart}" data-custom-start></label><label>To<input type="date" value="${T.customEnd}" data-custom-end></label></div>`:``}`;return t.wrap===!1?`<div class="period-controls compact-card">${n}</div>`:`<section class="card compact-card">${n}</section>`}function U(e,t=!0,n=``){let r=n?(T.dashSearchQuery[n]??``).toLowerCase():``,i=r?e.filter(e=>[e.description,e.category,e.flow_type,e.date].map(String).join(` `).toLowerCase().includes(r)):e,a=`<p class="sub" style="margin:0 0 8px;font-size:11px;">Showing ${i.length} entr${i.length===1?`y`:`ies`}${r?` matching "${r}"`:``}</p>`,o=`<div style="max-height:300px;overflow-y:auto;-webkit-overflow-scrolling:touch;">${i.length?i.map(e=>{let t=Number(e.amount??0)>=0?`income`:`expense`,n=String(e.direction??t),r=Number(e.amount??0);return`<div class="history-row">
        ...
        </div>`}).join(``):`<p class="sub">${r?`No entries match your search.`:`No entries yet.`}</p>`}</div>`;return t?`<section class="card">${a}${o}</section>`:`${a}${o}`}function qe(e,t,n=`var(--brand-teal)`){if(!t.length)return``;let r=Math.max(...t.map(e=>Math.abs(e.value)),1);return`<section class="card"><h3>${e}</h3>${t.map(e=>{let t=Math.max(4,Math.abs(e.value)/r*100);return`<div class="history-row" style="display:block;padding:8px 0;">
    ...
    </div>`}).join(``)}</section>`}var Je=[`Interest Earned`,`Interest Tax`,`Mobile Banking Charge`,`Debit Card Charge`,`Cheque Book`,`Locker`,`Demat Renewal`,`Demat & MeroShare Renewal`,`Broker Renewal`,`MeroShare Renewal`,`Other Charges`],Ye=new Set([`interest earned`,`income`]);function W(e){if(e==null||e===``)return 0;let t=Number(e);return Number.isFinite(t)?t:0}function G(e){return Ye.has(e.trim().toLowerCase())}function Xe(e){let t=0,n=0,r=Object.fromEntries(Je.map(e=>[e,0]));for(let i of e){let e=String(i.category??``).trim(),a=W(i.amount);if(G(e))t+=a,e in r?r[e]+=a:e&&(r[e]=(r[e]??0)+a);else{let t=Math.abs(a);n+=t,e&&(r[e]=(r[e]??0)+t)}}return{total_income:t,total_expenses:n,net_balance:t-n,category_totals:r}}function Ze(e,t){let n=W(t);return e===`income`?n:-n}function Qe(e){let t=String(e.category??``).trim().toLowerCase(),n=String(e.buy_sell??``).trim().toLowerCase();return t===`ipo`||t===`buy`?[`expense`,`Investment Expense`]:t===`sip`&&(n===`redeem`||n===`redeemed`)?[`income`,`Investment Income`]:t===`sip`?[`expense`,`Investment Expense`]:t===`sell`||t===`dividend`&&n===`cash`?[`income`,`Investment Income`]:null}function $e(e){let t=new Map([[`ipo:ipo`,`IPO`],[`buy:buy`,`Secondary buy`],[`sell:sell`,`Share sell`],[`sip:installment`,`SIP installment`],[`sip:redeem`,`SIP redeem`],[`sip:redeemed`,`SIP redeem`],[`dividend:cash`,`Cash dividend`]]),n=[];for(let r of e){let e=Qe(r),i=Math.abs(W(r.total_amount));if(!e||i<=0)continue;let[a,o]=e,s=String(r.category??``).trim().toLowerCase(),c=String(r.buy_sell??``).trim().toLowerCase(),l=Number(r.id??0),u=String(r.share_name??``).trim().toUpperCase(),d=t.get(`${s}:${c}`)??rt(s);n.push({id:`share-${l}`,display_id:`S-${l}`,date:String(r.date??``),flow_type:`bank`,direction:a,category:o,amount:i,signed_amount:Ze(a,i),description:`${d}: ${u}`,source:`share-sync`,timestamp:String(r.timestamp??``),source_ref:String(r.sync_ref??`share:${l}`)})}return n}function et(e){let t=[];for(let n of e){let e=String(n.category??``).trim(),r=Math.abs(W(n.amount));if(r<=0)continue;let i=G(e)?`income`:`expense`,a=i===`income`?`Interest Earned`:`Service Cost`,o=Number(n.id??0),s=String(n.description??``).trim(),c=e||a;t.push({id:`bank-services-${o}`,display_id:`BS-${o}`,date:String(n.date??``),flow_type:`bank`,direction:i,category:a,amount:r,signed_amount:Ze(i,r),description:`${c}${s?`: ${s}`:``}`,source:`bank-services-sync`,timestamp:String(n.timestamp??``),source_ref:`bank-services:${o}`})}return t}function tt(e){let t={bank:nt(),cash:nt()};for(let n of e){let e=String(n.flow_type??``).trim().toLowerCase();if(e!==`bank`&&e!==`cash`)continue;let r=String(n.direction??``).trim().toLowerCase(),i=String(n.category??``).trim()||`Uncategorized`,a=Math.abs(W(n.amount)),o=String(n.source??`manual`).trim().toLowerCase(),s=i.toLowerCase(),c=t[e];r===`income`?(c.total_income+=a,c.income_breakdown[i]=(c.income_breakdown[i]??0)+a,e===`bank`&&o===`bank-services-sync`?c.interest_earned+=a:e===`bank`&&s===`investment income`?c.investment_income+=a:c.income+=a):(c.total_expenses+=a,c.expense_breakdown[i]=(c.expense_breakdown[i]??0)+a,e===`bank`&&o===`bank-services-sync`?c.service_cost+=a:e===`bank`&&[`investment expense`,`investment`,`sip`,`share market`].includes(s)?c.investment_expense+=a:c.expenses+=a)}for(let e of Object.values(t))e.net=e.total_income-e.total_expenses;let n={overall_income:t.bank.total_income+t.cash.total_income,overall_expenses:t.bank.total_expenses+t.cash.total_expenses,overall_net:0,bank:t.bank,cash:t.cash};return n.overall_net=n.overall_income-n.overall_expenses,{bank:t.bank,cash:t.cash,combined:n}}function nt(){return{income:0,expenses:0,investment_expense:0,investment_income:0,interest_earned:0,service_cost:0,total_income:0,total_expenses:0,net:0,income_breakdown:{},expense_breakdown:{}}}function rt(e){return e&&`${e.charAt(0).toUpperCase()}${e.slice(1)}`}function it(e){let t=Number(e??0);return Number.isFinite(t)?Math.trunc(t):0}function at(e,t){let n=t,r=0;for(let t of e){if(n<=0)break;let e=t.qty,i=Math.min(e,n);if(r+=i*t.price,e>0&&t.asba!==0){let n=t.asba*(i/e);r+=n,t.asba-=n}t.qty=e-i,n-=i}if(n>0)throw Error(`Not enough available quantity to sell for this share.`);return r}function ot(e){let t=0,n=new Map,r=new Map;return e.map(e=>{let i=String(e.share_name??``).trim(),a=i.toLowerCase(),o=String(e.category??``).trim().toLowerCase(),s=W(e.per_unit_price),c=it(e.allotted),l=String(e.buy_sell??``).trim().toLowerCase(),u=o===`ipo`?5:0,d=0,f=0;if(o===`dividend`)l===`cash`&&(d=s,f=d);else if(o===`sip`){let t=l===`sip`?`installment`:l,n=W(e.total_amount);if(d=n>0?n:c>0?s*c:s,t===`redeem`){let e=r.get(a)??0;f=d-e,r.set(a,0),s=d,l=`redeem`}else r.set(a,(r.get(a)??0)+d),l=`installment`,s=c>0?d/c:d}else d=s*c+u;if(o===`ipo`||o===`buy`||o===`dividend`&&l===`bonus`){if(a){let e=n.get(a)??[];e.push({qty:c,price:o===`dividend`?0:s,asba:o===`ipo`?u:0}),n.set(a,e)}}else if(o===`sell`&&c>0){let e=at(n.get(a)??[],c);f=d-e}return t+=f,{id:e.id,date:String(e.date??``),share_name:i,category:o,per_unit_price:s,asba_charge:u,allotted:c,buy_sell:l,total_amount:d,profit_loss:f,cumulative_profit:t,timestamp:e.timestamp,sync_ref:e.sync_ref}})}function st(e){let t=0,n=0,r=0,i=0,a=0,o=0,s=0,c=0;for(let l of e){let e=String(l.category??``).trim().toLowerCase(),u=String(l.buy_sell??``).trim().toLowerCase(),d=W(l.total_amount),f=W(l.profit_loss);e===`ipo`?t+=d:e===`sip`&&(u===`redeem`||u===`redeemed`)?(r+=d,i+=f):e===`sip`?n+=d:e===`buy`?a+=d:e===`sell`?(o+=d,s+=f):e===`dividend`&&u===`cash`&&(c+=d)}let l=t+a,u=s+c-l,d=l+n;return{total_ipo_investment:t,total_sip_investment:n,total_sip_redeemed:r,sip_profit_loss:i,total_buy_amount:a,overall_investment:l,total_sell_amount:o,total_dividend:c,total_profit:s,overall_profit_loss:u,grand_total_investment:d,grand_profit_loss:u+i}}var K=[{id:1,date:`2026-08-01`,category:`Interest Earned`,amount:820,description:`Savings`,timestamp:`2026-08-01T09:00:00`},{id:2,date:`2026-08-04`,category:`Mobile Banking Charge`,amount:-25,description:`Monthly`,timestamp:`2026-08-04T09:00:00`},{id:3,date:`2026-08-10`,category:`Demat Renewal`,amount:-150,description:`Renewal`,timestamp:`2026-08-10T09:00:00`}],q=ot([{id:1,date:`2026-08-03`,share_name:`NABIL`,category:`ipo`,per_unit_price:100,allotted:10,buy_sell:`ipo`,timestamp:`2026-08-03T10:00:00`},{id:2,date:`2026-08-06`,share_name:`NABIL`,category:`sell`,per_unit_price:160,allotted:4,buy_sell:`sell`,timestamp:`2026-08-06T10:00:00`},{id:3,date:`2026-08-07`,share_name:`NIBL`,category:`sip`,per_unit_price:1e3,total_amount:1e3,allotted:20,buy_sell:`installment`,timestamp:`2026-08-07T10:00:00`}]),ct=[{id:1,display_id:`C-1`,date:`2026-08-20`,flow_type:`cash`,direction:`expense`,category:`Food`,amount:560,signed_amount:-560,description:`Grocery top-up`,source:`manual`,timestamp:`2026-08-20T18:00:00`},{id:2,display_id:`B-2`,date:`2026-08-01`,flow_type:`bank`,direction:`income`,category:`Salary`,amount:45e3,signed_amount:45e3,description:`Salary`,source:`manual`,timestamp:`2026-08-01T08:00:00`},{id:3,display_id:`C-3`,date:`2026-08-18`,flow_type:`cash`,direction:`expense`,category:`Entertainment`,amount:900,signed_amount:-900,description:`Movie night`,source:`manual`,timestamp:`2026-08-18T20:00:00`}],lt=[{id:1,date:`2026-08-22`,from_flow:`cash`,to_flow:`bank`,amount:2e3,description:`Deposit`}];function J(){return[...ct,...$e(q),...et(K)]}function Y(){let e=C(y());return J().filter(t=>t.source===`manual`&&String(t.date).startsWith(e))}function ut(e){let t=e.filter(e=>e.direction===`income`).reduce((e,t)=>e+Number(t.amount||0),0),n=e.filter(e=>e.direction===`expense`).reduce((e,t)=>e+Number(t.amount||0),0);return{income:t,expense:n,net:t-n}}function dt(){return ut(Y())}function ft(){return ut(J().filter(e=>e.source===`manual`&&e.date===b(y())))}function pt(e){return e.reduce((e,t)=>e+Number(t.amount||0),0)}function mt(){let e=dt(),t=ft(),n=ht(),r=gt(),i=pt(n),a=[...n].sort((e,t)=>String(t.date).localeCompare(String(e.date))).slice(0,4),o=ne(y());return`
    ${_t()}
    ...
    <section class="card">
      ...
      ${Ke([`week`,`month`,`year`,`custom`],{wrap:!1})}
      ${we(r)}
    </section>
    <section class="card">
  ...
  `}function X(){let e=new Set;for(let t of Y())e.add(String(t.category||`Other`));return[...e].sort((e,t)=>e.localeCompare(t))}function Z(){let e=X();return T.categorySelectionTouched||(T.selectedHomeCategories=new Set(e)),e.filter(e=>T.selectedHomeCategories.has(e))}function ht(){let e=new Set(Z());return Y().filter(t=>t.direction===T.homeMode&&e.has(String(t.category||`Other`)))}function gt(){let e=new Set(Z());return Y().filter(t=>e.has(String(t.category||`Other`)))}function _t(){return ce()?`
  ...
  `:``}function vt(){let e=X(),t=new Set(Z());return e.length?`
  ...
  `:`<p class="sub">No categories have entries for ${ne(y())} yet.</p>`}function yt(){return Ie(`Bank Services`,`Add bank entry`,[[`Date`,`date`],[`Category`,`select`,`Interest Earned`],[`Amount`,`number`],[`Description (optional)`,`text`]],`Add bank entry`,`bank-dash`)}function bt(){let e=Xe(K),t=Object.entries(e.category_totals??{}).filter(([e])=>e.toLowerCase()!==`interest earned`).map(([e,t])=>({label:e,value:Math.abs(Number(t))})).filter(e=>e.value>0).sort((e,t)=>t.value-e.value),n=xt(K),r=K.map(e=>({...e,amount:Number(e.amount),direction:Number(e.amount)>=0?`income`:`expense`,flow_type:`bank`}));return`
    ...
    ${R([[`Interest earned`,e.total_income,`pos`],[`Total charges`,e.total_expenses,`neg`],[`Net balance`,e.net_balance,e.net_balance>=0?`pos`:`neg`]],2,!0)}

    ${qe(`Charges by category`,t,`var(--brand-teal)`)}

    ${Ge(`Bank services trend`,n,{ranges:[`month`,`year`,`custom`],activeRange:T.bankRange,rangeAttr:`data-bank-range`})}

    <section class="card">
      ${I(`All transactions`,`Filter`)}
      ${L(`bank`,`Search by category or description`)}
      ${U(r,!1,`bank`)}
    </section>

    ${P(`home`,`bank-add`)}
  `}function xt(e){return z(T.bankRange,!0).map(t=>{let n=0,r=0;for(let i of e){if(!(t.isDay?i.date===t.key:String(i.date).startsWith(t.key)))continue;let e=Number(i.amount??0);G(String(i.category??``))?n+=e:r+=Math.abs(e)}return{label:t.label,sublabel:t.sublabel,key:t.key,income:n,expense:r,net:n-r}})}function St(){return`
    ...
    ${P(`home`,`expenses-dash`)}
  `}function Ct(){let e=J(),t=tt(e),n=T.expensesDashTab,r=n===`bank`?e.filter(e=>e.flow_type===`bank`):n===`cash`?e.filter(e=>e.flow_type===`cash`):e,i=wt(r),a=lt[0];return`
    <p class="eyebrow">Personal Expenses</p>
    ...
    <section class="card">
      ...
      ${n===`combined`?`${R([[`Income`,t.combined.overall_income,`pos`],[`Expenses`,t.combined.overall_expenses,`neg`],[`Bank net`,t.bank.net,t.bank.net>=0?`pos`:`neg`],[`Cash net`,t.cash.net,t.cash.net>=0?`pos`:`neg`]])}
          ...
          </div>`:R(n===`bank`?[[`Bank income`,t.bank.income,`pos`],[`Bank expense`,t.bank.expenses,`neg`],[`Investment income`,t.bank.investment_income,`pos`],[`Investment expense`,t.bank.investment_expense,`neg`],[`Interest earned`,t.bank.interest_earned,`pos`],[`Service cost`,t.bank.service_cost,`neg`],[`Total income`,t.bank.total_income,`pos`],[`Total expense`,t.bank.total_expenses,`neg`],[`Bank net`,t.bank.net,t.bank.net>=0?`pos`:`neg`]]:[[`Cash income`,t.cash.total_income,`pos`],[`Cash expense`,t.cash.total_expenses,`neg`],[`Cash net`,t.cash.net,t.cash.net>=0?`pos`:`neg`]])}
    </section>

    ${Ge(`Money flow trend`,i)}

    <section class="card">
      ${I(`All transactions`,`Filter`)}
      ${L(`expenses`,`Search by category or description`)}
      ${U(r,!1,`expenses`)}
    </section>

    ${P(`home`,`expenses-add`)}
  `}function wt(e){return z().map(t=>{let n=0,r=0;for(let i of e){if(!(t.isDay?i.date===t.key:String(i.date).startsWith(t.key)))continue;let e=Number(i.amount??0);i.direction===`income`?n+=e:r+=e}return{label:t.label,sublabel:t.sublabel,key:t.key,income:n,expense:r,net:n-r}})}function Tt(){return`
  ...
  `}function Lt(){let e=T.sharesEntryType,t=zt(),n=[`ipo`,`buy`,`sell`].includes(e),r=[`ipo`,`buy`,`sell`].includes(e),i=e===`buy`,a=[`sip`,`dividend`].includes(e),o=e===`dividend`,s=e===`sip`,c=e===`sip`;return`
    ...
    <section class="card">
      ...
      ${L(`shares-portfolio`,`Filter by share name`)}
      ${t}
    </section>
    ...
    <section class="card">
      ...
      ${F(`Date`,`date`)}
      ${F(`Share name`,`text`)}
      ${n?F(`Per unit price`,`number`):``}
      ${r?F(`Quantity / Allotted`,`number`):``}
      ${i?F(`Total Amount`,`number`):``}
      ${a?F(`Amount`,`number`):``}
      ${o?F(`Dividend Type`,`select`,`cash`):``}
      ${s?F(`SIP type`,`select`,`installment`):``}
      ${c?F(`Total SIP shares`,`number`):``}
      <button class="btn-primary">Add share entry</button>
    </section>
    ${P(`home`,`shares-dash`)}
  `}function Rt(){let e=st(q),t=zt(),n=Bt(),r=q.map(e=>({description:`${String(e.share_name).toUpperCase()} · ${e.category}`,category:String(e.buy_sell??``),amount:Number(e.total_amount),direction:Number(e.profit_loss??0)>=0?`income`:`expense`,flow_type:`shares`,date:e.date}));return`
    <p class="eyebrow">Share Portfolio</p>
    ...
    <section class="card">
      ...
      ${L(`shares-portfolio`,`Search by share name`)}
      ${t}
    </section>

    <section class="card">
      <h3>IPO &amp; secondary position</h3>
      ${R([[`IPO invest`,e.total_ipo_investment,`neg`],[`Secondary buy`,e.total_buy_amount,`neg`],[`Total sell`,e.total_sell_amount,`pos`],[`Dividend`,e.total_dividend,`pos`],[`Realized profit`,e.total_profit,e.total_profit>=0?`pos`:`neg`],[`Overall P/L`,e.overall_profit_loss,e.overall_profit_loss>=0?`pos`:`neg`]])}
    </section>

    <section class="card">
      <h3>SIP position</h3>
      ${R([[`Invested`,e.total_sip_investment,`neg`],[`Redeemed`,e.total_sip_redeemed,`pos`],[`SIP profit/loss`,e.sip_profit_loss,e.sip_profit_loss>=0?`pos`:`neg`]],2,!0)}
    </section>

    <section class="card stat-card-purple">
      <h3>Grand total</h3>
      ${R([[`Investment`,e.grand_total_investment,`neg`],[`Profit/Loss`,e.grand_profit_loss,e.grand_profit_loss>=0?`pos`:`neg`]])}
    </section>

    ${H(`Portfolio value trend`,n,[{label:`Share movement`,color:`var(--accent-purple)`}])}
    ...
    <section class="card">
      ${I(`Transaction history`,`Filter`)}
      ${L(`shares`,`Search by share name or type`)}
      ${U(r,!1,`shares`)}
    </section>
  ...
  `}function zt(){let e=new Map;for(let t of q){let n=String(t.share_name??``).toUpperCase(),r=Number(t.allotted??0);e.set(n,(e.get(n)??0)+(t.buy_sell===`sell`?-r:r))}let t=(T.dashSearchQuery[`shares-portfolio`]??``).toLowerCase(),n=[...e.entries()].filter(([,e])=>e>0).filter(([e])=>!t||e.toLowerCase().includes(t)).sort((e,t)=>e[0].localeCompare(t[0]));return n.length?`<table class="mini">
  ...
  </table>`:`<p class="sub">${t?`No shares match your search.`:`No remaining holdings.`}</p>`}function Bt(){return z().map(e=>{let t=q.filter(t=>e.isDay?t.date===e.key:String(t.date).startsWith(e.key)).reduce((e,t)=>e+Math.abs(Number(t.total_amount??0)),0);return{label:e.label,sublabel:e.sublabel,value:t,color:`var(--accent-purple)`}})}function Vt(){let e=Xe(K),t=st(q),n=tt(J()),r=e.net_balance+t.grand_profit_loss+n.combined.overall_net,i=Ht(e.net_balance,t.grand_profit_loss,n.combined.overall_net);return`
    ...
    ${R([[`Bank net`,e.net_balance,e.net_balance>=0?`pos`:`neg`],[`Share P/L`,t.grand_profit_loss,t.grand_profit_loss>=0?`pos`:`neg`],[`Expenses net`,n.combined.overall_net,n.combined.overall_net>=0?`pos`:`neg`],[`Overall net`,r,r>=0?`pos`:`neg`]])}

    ${H(`Net worth trend`,i,[{label:`Net ≥ 0`,color:`var(--brand-teal)`},{label:`Net < 0`,color:`var(--accent-amber)`}])}
    ...
    ${P(`home`)}
  `}function Ht(e,t,n){let r=new Date().toISOString().slice(0,10),i=r.slice(0,7);return z().map(a=>{let o=(a.isDay?a.key===r:a.key===i)?e+t+n:0,s=o>=0?`var(--brand-teal)`:`var(--accent-amber)`;return{label:a.label,sublabel:a.sublabel,value:o,color:s}})}function Ut(){return`
