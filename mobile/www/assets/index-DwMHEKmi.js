(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e;(function(e){e.Unimplemented=`UNIMPLEMENTED`,e.Unavailable=`UNAVAILABLE`})(e||={});var t=class extends Error{constructor(e,t,n){super(e),this.message=e,this.code=t,this.data=n}},n=e=>e?.androidBridge?`android`:e?.webkit?.messageHandlers?.bridge?`ios`:`web`,r=r=>{let i=r.CapacitorCustomPlatform||null,a=r.Capacitor||{},o=a.Plugins=a.Plugins||{},s=()=>i===null?n(r):i.name,c=()=>s()!==`web`,l=e=>!!(f.get(e)?.platforms.has(s())||u(e)),u=e=>a.PluginHeaders?.find(t=>t.name===e),d=e=>r.console.error(e),f=new Map;return a.convertFileSrc||=e=>e,a.getPlatform=s,a.handleError=d,a.isNativePlatform=c,a.isPluginAvailable=l,a.registerPlugin=(n,r={})=>{let c=f.get(n);if(c)return console.warn(`Capacitor plugin "${n}" already registered. Cannot register plugins twice.`),c.proxy;let l=s(),d=u(n),p,m=async()=>(!p&&l in r?p=p=typeof r[l]==`function`?await r[l]():r[l]:i!==null&&!p&&`web`in r&&(p=p=typeof r.web==`function`?await r.web():r.web),p),ee=(r,i)=>{if(d){let e=d?.methods.find(e=>i===e.name);if(e)return e.rtype===`promise`?e=>a.nativePromise(n,i.toString(),e):(e,t)=>a.nativeCallback(n,i.toString(),e,t);if(r)return r[i]?.bind(r)}else if(r)return r[i]?.bind(r);else throw new t(`"${n}" plugin is not implemented on ${l}`,e.Unimplemented)},h=r=>{let i,a=(...a)=>{let o=m().then(o=>{let s=ee(o,r);if(s){let e=s(...a);return i=e?.remove,e}throw new t(`"${n}.${r}()" is not implemented on ${l}`,e.Unimplemented)});return r===`addListener`&&(o.remove=async()=>i()),o};return a.toString=()=>`${r.toString()}() { [capacitor code] }`,Object.defineProperty(a,"name",{value:r,writable:!1,configurable:!1}),a},g=h(`addListener`),_=h(`removeListener`),v=(e,t)=>{let n=g({eventName:e},t),r=async()=>{let r=await n;_({eventName:e,callbackId:r},t)},i=new Promise(e=>n.then(()=>e({remove:r})));return i.remove=async()=>{console.warn(`Using addListener() without 'await' is deprecated.`),await r()},i},y=new Proxy({},{get(e,t){switch(t){case`$$typeof`:return;case`toJSON`:return()=>({});case`addListener`:return d?v:g;case`removeListener`:return _;default:return h(t)}}});return o[n]=y,f.set(n,{name:n,proxy:y,platforms:new Set([...Object.keys(r),...d?[l]:[]])}),y},a.Exception=t,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},i=(e=>e.Capacitor=r(e))(typeof globalThis<`u`?globalThis:typeof self<`u`?self:typeof window<`u`?window:typeof global<`u`?global:{}),a=i.registerPlugin,o=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(t);let r=this.windowListeners[e];return r&&!r.registered&&this.addWindowListener(r),n&&this.sendRetainedArgumentsForEvent(e),Promise.resolve({remove:async()=>this.removeListener(e,t)})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,n){let r=this.listeners[e];if(!r){if(n){let n=this.retainedEventArguments[e];n||=[],n.push(t),this.retainedEventArguments[e]=n}return}r.forEach(e=>e(t))}hasListeners(e){return!!this.listeners[e]?.length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:e=>{this.notifyListeners(t,e)}}}unimplemented(t=`not implemented`){return new i.Exception(t,e.Unimplemented)}unavailable(t=`not available`){return new i.Exception(t,e.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let r=n.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(t=>{this.notifyListeners(e,t)}))}},s=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),c=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),l=class extends o{async getCookies(){let e=document.cookie,t={};return e.split(`;`).forEach(e=>{if(e.length<=0)return;let[n,r]=e.replace(/=/,`CAP_COOKIE`).split(`CAP_COOKIE`);n=c(n).trim(),r=c(r).trim(),t[n]=r}),t}async setCookie(e){try{let t=s(e.key),n=s(e.value),r=e.expires?`; expires=${e.expires.replace(`expires=`,``)}`:``,i=(e.path||`/`).replace(`path=`,``),a=e.url!=null&&e.url.length>0?`domain=${e.url}`:``;document.cookie=`${t}=${n||``}${r}; path=${i}; ${a};`}catch(e){return Promise.reject(e)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(e){return Promise.reject(e)}}async clearCookies(){try{let e=document.cookie.split(`;`)||[];for(let t of e)document.cookie=t.replace(/^ +/,``).replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}};a(`CapacitorCookies`,{web:()=>new l});var u=async e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{let e=r.result;t(e.indexOf(`,`)>=0?e.split(`,`)[1]:e)},r.onerror=e=>n(e),r.readAsDataURL(e)}),d=(e={})=>{let t=Object.keys(e);return Object.keys(e).map(e=>e.toLocaleLowerCase()).reduce((n,r,i)=>(n[r]=e[t[i]],n),{})},f=(e,t=!0)=>e?Object.entries(e).reduce((e,n)=>{let[r,i]=n,a,o;return Array.isArray(i)?(o=``,i.forEach(e=>{a=t?encodeURIComponent(e):e,o+=`${r}=${a}&`}),o.slice(0,-1)):(a=t?encodeURIComponent(i):i,o=`${r}=${a}`),`${e}&${o}`},``).substr(1):null,p=(e,t={})=>{let n=Object.assign({method:e.method||`GET`,headers:e.headers},t),r=d(e.headers)[`content-type`]||``;if(typeof e.data==`string`)n.body=e.data;else if(r.includes(`application/x-www-form-urlencoded`)){let t=new URLSearchParams;for(let[n,r]of Object.entries(e.data||{}))t.set(n,r);n.body=t.toString()}else if(r.includes(`multipart/form-data`)||e.data instanceof FormData){let t=new FormData;if(e.data instanceof FormData)e.data.forEach((e,n)=>{t.append(n,e)});else for(let n of Object.keys(e.data))t.append(n,e.data[n]);n.body=t;let r=new Headers(n.headers);r.delete(`content-type`),n.headers=r}else(r.includes(`application/json`)||typeof e.data==`object`)&&(n.body=JSON.stringify(e.data));return n},m=class extends o{async request(e){let t=p(e,e.webFetchExtra),n=f(e.params,e.shouldEncodeUrlParams),r=n?`${e.url}?${n}`:e.url,i=await fetch(r,t),a=i.headers.get(`content-type`)||``,{responseType:o=`text`}=i.ok?e:{};a.includes(`application/json`)&&(o=`json`);let s,c;switch(o){case`arraybuffer`:case`blob`:c=await i.blob(),s=await u(c);break;case`json`:s=await i.json();break;default:s=await i.text()}let l={};return i.headers.forEach((e,t)=>{l[t]=e}),{data:s,headers:l,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:`GET`}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:`POST`}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:`PUT`}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:`PATCH`}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:`DELETE`}))}};a(`CapacitorHttp`,{web:()=>new m});var ee=`modulepreload`,h=function(e){return`/`+e},g={},_=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=h(t,n),t=s(t),t in g)return;g[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:ee,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},v=a(`App`,{web:()=>_(()=>import(`./web-C9yIp4kA.js`).then(e=>new e.AppWeb),[])});function y(){return new Date}function b(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function x(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t,n-1,r)}function S(e,t){let n=new Date(e);return n.setDate(n.getDate()+t),n}function te(e,t){let n=x(e).getTime(),r=x(t).getTime();return Math.floor((r-n)/864e5)+1}function C(e){return b(e).slice(0,7)}function ne(e){return e.toLocaleString(`en-US`,{month:`long`})}var re=`mobile-local`,ie=`mobile-v1.0.0`,ae=`finledge.mobile.profileName`,w=`finledge.mobile.profilePromptDismissed`,T={activeScreen:`home`,screenHistory:[`home`],lastHomeBackPress:0,homeMode:`expense`,homeRange:`week`,bankRange:`month`,selectedHomeCategories:new Set,categorySelectionTouched:!1,customStart:b(new Date(y().getFullYear(),y().getMonth(),1)),customEnd:b(y()),dashSearchQuery:{bank:``,shares:``,expenses:``},expensesDashTab:`combined`,sharesEntryType:`ipo`,sharesDividendType:`cash`,sharesSipType:`installment`};function oe(){let e=new Date().getHours();return e<12?`Good morning`:e<17?`Good afternoon`:`Good evening`}function E(){return window.localStorage.getItem(ae)?.trim()||``}function se(){return(E()||`F`).slice(0,1).toUpperCase()}function ce(){return!E()&&!window.localStorage.getItem(w)}function le(e){let t=e.trim();t&&(window.localStorage.setItem(ae,t),window.localStorage.setItem(w,`1`))}function ue(){window.localStorage.setItem(w,`1`)}function de(e){document.querySelector(`.toast`)?.remove();let t=document.createElement(`div`);t.className=`toast`,t.textContent=e,document.body.appendChild(t),window.setTimeout(()=>t.remove(),1600)}function fe(){v.exitApp()}var pe=[`Interest Earned`,`Interest Tax`,`Mobile Banking Charge`,`Debit Card Charge`,`Cheque Book`,`Locker`,`Demat Renewal`,`Demat & MeroShare Renewal`,`Broker Renewal`,`MeroShare Renewal`,`Other Charges`],me=[`ipo`,`sip`,`buy`,`sell`,`dividend`],he={ipo:`IPO entry`,sip:`SIP investment`,buy:`Secondary buy`,sell:`Sell shares`,dividend:`Dividend`},ge=[{value:`bank`,label:`Bank Flow`},{value:`cash`,label:`Cash Flow`}],_e=[{value:`expense`,label:`Expense`},{value:`income`,label:`Income`}],ve=[`Food`,`Transportation`,`Entertainment`,`Shopping`,`Health`,`Education`,`Bills`,`Rent`,`Travel`,`Insurance`,`Investment`,`SIP`,`Share Market`,`Other`],ye=[`Salary`,`Freelance`,`Business`,`Prize/Lottery`,`Gift`,`Refund`,`Investment Income`,`Investment Return`,`Dividend`,`Share Sell Proceeds`,`Other Income`];function D(e,t={}){let n=Math.abs(e).toLocaleString(`en-US`,{maximumFractionDigits:2});return t.sign?`${e>=0?`+`:`-`}Rs ${n}`:`Rs ${n}`}function O(e){let t=e<0?`-`:``,n=Math.abs(e);return n>=1e5?`${t}${(n/1e5).toFixed(n%1e5==0?0:1)}L`:n>=1e3?`${t}${(n/1e3).toFixed(n%1e3==0?0:1)}k`:`${t}${n.toLocaleString(`en-US`,{maximumFractionDigits:0})}`}var k=`var(--accent-green)`,A=`var(--accent-red)`,be=`var(--brand-teal)`,xe=`var(--accent-amber)`,Se=72,Ce=88;function we(e){let t=Ae(e);return typeof t==`string`?`<p class="sub range-warning">${t}</p>`:`${Te(t)}${Ee()}`}function Te(e){if(!e.length)return`<p class='sub'>No data for this period.</p>`;let t=Math.max(...e.flatMap(e=>[e.income,e.expense,Math.abs(e.net)]),1);return`
  ...
  `}function Ee(){return`<div class="chart-legend" style="margin-top:10px;display:flex;flex-wrap:wrap;gap:10px;">
      <span><i style="display:inline-block;width:10px;height:10px;border-radius:3px;background:${k};margin-right:4px;vertical-align:middle;"></i>Income</span>
      <span><i style="display:inline-block;width:10px;height:10px;border-radius:3px;background:${A};margin-right:4px;vertical-align:middle;"></i>Expense</span>
      <span><i style="display:inline-block;width:10px;height:10px;border-radius:3px;background:${be};margin-right:4px;vertical-align:middle;"></i>Net ≥0</span>
    ...
    </div>`}function De(e,t){let n=e.net>=0?be:xe;return`<div class="grouped-bar-col" style="width:${Se}px;">
    <div class="grouped-bar-sticks">${[{value:e.income,color:k,show:e.income>0,label:O(e.income)},{value:e.expense,color:A,show:e.expense>0,label:O(e.expense)},{value:Math.abs(e.net),color:n,show:e.net!==0,label:O(e.net)}].map(e=>Oe(e,t)).join(``)}</div>
    <span class="grouped-bar-x">${e.label}</span>
    <span class="grouped-bar-sub">${e.sublabel??``}</span>
  </div>`}function Oe(e,t){if(!e.show||Math.abs(e.value)<.01)return`<div class="grouped-bar-stick grouped-bar-stick-empty"></div>`;let n=Math.max(4,Math.abs(e.value)/t*Ce);return`<div class="grouped-bar-stick">
  ...
  </div>`}function ke(e){let t=new Map;for(let n of e){let e=String(n.category??`Other`);t.set(e,(t.get(e)??0)+Number(n.amount??0))}let n=[...t.entries()].sort((e,t)=>t[1]-e[1]).slice(0,5);if(!n.length)return`<p class="sub">Nothing to show for the selected ${T.homeMode} categories yet.</p>`;let r=Math.max(...n.map(([,e])=>e),1),i=T.homeMode===`income`?`pos`:`neg`,a=T.homeMode===`income`?k:A;return n.map(([e,t])=>`<div class="history-row"><b>${e}</b><span class="money ${i}">${O(t)}</span></div>
     <div class="category-meter"><i style="width:${Math.max(8,t/r*100)}%;background:${a};"></i></div>`).join(``)}function Ae(e){let t=y();if(T.homeRange===`week`)return j(e,S(t,-89),t);if(T.homeRange===`month`)return j(e,S(t,-399),t);if(T.homeRange===`year`)return je(e,48);let n=te(T.customStart,T.customEnd);return n<1?`Choose an end date after the start date.`:n>365?`Custom range supports up to 365 days.`:j(e,x(T.customStart),x(T.customEnd))}function j(e,t,n){let r=new Map;for(let e=new Date(t);e<=n;e=S(e,1)){let t=b(e),n=e.toLocaleString(`en-US`,{month:`short`});r.set(t,{label:String(e.getDate()),sublabel:n,key:t,income:0,expense:0,net:0})}for(let t of e){let e=r.get(String(t.date));e&&Me(e,t)}return[...r.values()]}function je(e,t){let n=y();return Array.from({length:t},(r,i)=>{let a=new Date(n.getFullYear(),n.getMonth()-(t-1-i),1),o=C(a),s=String(a.getFullYear()).slice(2),c={label:a.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${s}`,key:o,income:0,expense:0,net:0};for(let t of e)String(t.date).startsWith(o)&&Me(c,t);return c})}function Me(e,t){let n=Number(t.amount||0);t.direction===`income`?(e.income+=n,e.net+=n):(e.expense+=n,e.net-=n)}var Ne=b(y());function M(e,t){return`<main class="screen ${T.activeScreen===e?`active`:``}" data-screen="${e}">${t}</main>`}function Pe(){let e=E();return`
    <header class="topbar">
  ...
  `}function Fe(){return`
    ...
    <nav class="drawer" aria-label="Mobile navigation">
      <div class="drawer-head"><img class="mark mark-img" src="./icon.png" alt="FinLedge logo"><div class="brand-text"><b>FinLedge</b><span>${ie} / ${re}</span></div></div>
  ...
  `}function N(e,t){let n=[`<button class="btn-secondary" type="button" data-back="${e}">Back</button>`,`<button class="btn-secondary" type="button" data-nav="home">Home</button>`];if(t){let e=t.endsWith(`dash`)?`View dashboard`:`Add entry`;n.push(`<button class="btn-secondary" type="button" data-nav="${t}">${e}</button>`)}return`<div class="btn-row ${t?`btn-row-3`:`btn-row-2`}">${n.join(``)}</div>`}function Ie(e,t,n,r,i){return`<p class="eyebrow">${e}</p><h1 class="pagehead">${t}</h1><p class="sub">Stored locally on this device.</p>${Le(n,r)}${N(`home`,i)}`}function Le(e,t){return`<section class="card">${e.map(([e,t,n])=>P(e,t,n)).join(``)}<button class="btn-primary">${t}</button></section>`}function P(e,t,n){return t===`select`?`<div class="field"><label>${e}</label><select>${Re(e,n)}</select></div>`:`<div class="field"><label>${e}</label><input type="${t}" ${t===`number`?`inputmode="decimal"`:``} value="${t===`date`?Ne:n??``}"></div>`}function Re(e,t=`Other`){return({Category:pe.includes(t??``)?pe:[...ve,...ye],"Entry type":me,Flow:ge.map(e=>e.label),Type:_e.map(e=>e.label),"Dividend Type":[`cash`,`bonus`],"SIP type":[`installment`,`redeem`]}[e]||[t??`Other`,`Other`]).map(e=>`<option value="${e}">${he[e]||e}</option>`).join(``)}function F(e,t=``){return`<div class="section-title"><h3>${e}</h3>${t?`<span>${t}</span>`:``}</div>`}function I(e,t=`Search`){return`<input class="search-input" type="search" placeholder="${t}" value="${(T.dashSearchQuery[e]??``).replace(/"/g,`&quot;`)}" data-search-module="${e}" autocomplete="off">`}function L(e,t=2,n=!1){return`<div class="${t===3?`stat-grid split-3`:`stat-grid`}">${e.map(([t,r,i],a)=>{let o=a===e.length-1;return`<div class="stat-box${n&&o?` stat-box-full`:``}"><div class="label">${t}</div><div class="value money ${i}">${D(r,{sign:i===`pos`||i===`neg`})}</div></div>`}).join(``)}</div>`}function R(e=T.homeRange,t=!1){let n=y();if(t&&e===`week`&&(e=`month`),e===`week`&&!t)return Array.from({length:90},(e,t)=>{let r=S(n,t-89);return{label:String(r.getDate()),sublabel:r.toLocaleString(`en-US`,{month:`short`}),key:b(r),isDay:!0}});if(e===`month`)return t?Array.from({length:13},(e,t)=>{let r=new Date(n.getFullYear(),n.getMonth()-(12-t),1),i=String(r.getFullYear()).slice(2);return{label:r.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${i}`,key:C(r),isDay:!1}}):Array.from({length:400},(e,t)=>{let r=S(n,t-399);return{label:String(r.getDate()),sublabel:r.toLocaleString(`en-US`,{month:`short`}),key:b(r),isDay:!0}});if(e===`year`)return Array.from({length:48},(e,t)=>{let r=new Date(n.getFullYear(),n.getMonth()-(47-t),1),i=String(r.getFullYear()).slice(2);return{label:r.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${i}`,key:C(r),isDay:!1}});if(e!==`custom`)return[];let r=te(T.customStart,T.customEnd);if(r<=60)return Array.from({length:r},(e,t)=>{let n=S(x(T.customStart),t);return{label:String(n.getDate()),sublabel:n.toLocaleString(`en-US`,{month:`short`}),key:b(n),isDay:!0}});let i=[],a=new Date(x(T.customStart));a.setDate(1);let o=x(T.customEnd);for(;a<=o;){let e=String(a.getFullYear()).slice(2);i.push({label:a.toLocaleString(`en-US`,{month:`short`}),sublabel:`'${e}`,key:C(a),isDay:!1}),a=new Date(a.getFullYear(),a.getMonth()+1,1)}return i}var ze=44,Be=88;function Ve(e){if(!e.length)return`<p class='sub'>No data for this period.</p>`;let t=e.filter(e=>Math.abs(e.value)>0),n=t.length?Math.max(...t.map(e=>Math.abs(e.value))):1;e.length*50;let r=e.map(e=>{let t=Math.abs(e.value)>=.01,r=t?Math.max(4,Math.abs(e.value)/n*Be):0,i=t?`<div class="single-bar-stick">
          <span class="single-bar-val" style="color:${e.color};">${O(e.value)}</span>
  ...
  </div>`}function He(e){return e.length*50+16}function Ue({ranges:e=[`week`,`month`,`year`,`custom`],activeRange:t=T.homeRange,rangeAttr:n=`data-home-range`}={}){return`<div class="segmented graph-tabs period-tabs" style="margin-bottom:8px;">${e.map(e=>`<button class="${t===e?`active`:``}" ${n}="${e}">${e[0].toUpperCase()}${e.slice(1)}</button>`).join(``)}</div>${t===`custom`?`<div class="custom-range"><label>From<input type="date" value="${T.customStart}" data-custom-start></label><label>To<input type="date" value="${T.customEnd}" data-custom-end></label></div>`:``}`}function z(e,t,n,r={}){let i=n.map(e=>`<span><i style="display:inline-block;width:10px;height:10px;border-radius:3px;background:${e.color};margin-right:5px;vertical-align:middle;"></i>${e.label}</span>`).join(``);return`<section class="card">
  ...
  </section>`}function We(e,t,n={}){return`<section class="card">
    <div class="section-title"><h3>${e}</h3></div>
    ${Ue(n)}
    ${Te(t)}
    ${Ee()}
  </section>`}function Ge(e,t={wrap:!0}){let n=`<div class="segmented graph-tabs period-tabs">${e.map(e=>`<button class="${T.homeRange===e?`active`:``}" data-home-range="${e}">${e[0].toUpperCase()}${e.slice(1)}</button>`).join(``)}</div>
    ${T.homeRange===`custom`?`<div class="custom-range"><label>From<input type="date" value="${T.customStart}" data-custom-start></label><label>To<input type="date" value="${T.customEnd}" data-custom-end></label></div>`:``}`;return t.wrap===!1?`<div class="period-controls compact-card">${n}</div>`:`<section class="card compact-card">${n}</section>`}function B(e,t=!0,n=``){let r=n?(T.dashSearchQuery[n]??``).toLowerCase():``,i=r?e.filter(e=>[e.description,e.category,e.flow_type,e.date].map(String).join(` `).toLowerCase().includes(r)):e,a=`<p class="sub" style="margin:0 0 8px;font-size:11px;">Showing ${i.length} entr${i.length===1?`y`:`ies`}${r?` matching "${r}"`:``}</p>`,o=`<div style="max-height:300px;overflow-y:auto;-webkit-overflow-scrolling:touch;">${i.length?i.map(e=>{let t=Number(e.amount??0)>=0?`income`:`expense`,n=String(e.direction??t),r=Number(e.amount??0);return`<div class="history-row">
          <div class="meta"><b>${String(e.description??e.category??`Entry`)}</b><span>${[e.category,e.date].filter(Boolean).map(String).join(` · `)}</span></div>
        ...
        </div>`}).join(``):`<p class="sub">${r?`No entries match your search.`:`No entries yet.`}</p>`}</div>`;return t?`<section class="card">${a}${o}</section>`:`${a}${o}`}function Ke(e,t,n=`var(--brand-teal)`){if(!t.length)return``;let r=Math.max(...t.map(e=>Math.abs(e.value)),1);return`<section class="card"><h3>${e}</h3>${t.map(e=>{let t=Math.max(4,Math.abs(e.value)/r*100);return`<div class="history-row" style="display:block;padding:8px 0;">
    ...
    <section class="card">
      ...
      ${Ge([`week`,`month`,`year`,`custom`],{wrap:!1})}
      ${we(r)}
    </section>
    <section class="card">
  ...
  `}function q(){let e=new Set;for(let t of K())e.add(String(t.category||`Other`));return[...e].sort((e,t)=>e.localeCompare(t))}function J(){let e=q();return T.categorySelectionTouched||(T.selectedHomeCategories=new Set(e)),e.filter(e=>T.selectedHomeCategories.has(e))}function mt(){let e=new Set(J());return K().filter(t=>t.direction===T.homeMode&&e.has(String(t.category||`Other`)))}function ht(){let e=new Set(J());return K().filter(t=>e.has(String(t.category||`Other`)))}function gt(){return ce()?`
  ...
  `:``}function _t(){let e=q(),t=new Set(J());return e.length?`
  ...
  `:`<p class="sub">No categories have entries for ${ne(y())} yet.</p>`}function vt(){return Ie(`Bank Services`,`Add bank entry`,[[`Date`,`date`],[`Category`,`select`,`Interest Earned`],[`Amount`,`number`],[`Description (optional)`,`text`]],`Add bank entry`,`bank-dash`)}function yt(){let e=Ye(U),t=Object.entries(e.category_totals??{}).filter(([e])=>e.toLowerCase()!==`interest earned`).map(([e,t])=>({label:e,value:Math.abs(Number(t))})).filter(e=>e.value>0).sort((e,t)=>t.value-e.value),n=bt(U),r=U.map(e=>({...e,amount:Number(e.amount),direction:Number(e.amount)>=0?`income`:`expense`,flow_type:`bank`}));return`
    ...
    ${Ke(`Charges by category`,t,`var(--brand-teal)`)}

    ${We(`Bank services trend`,n,{ranges:[`month`,`year`,`custom`],activeRange:T.bankRange,rangeAttr:`data-bank-range`})}
    ...
    ${N(`home`,`bank-add`)}
  `}function bt(e){return R(T.bankRange,!0).map(t=>{let n=0,r=0;for(let i of e){if(!(t.isDay?i.date===t.key:String(i.date).startsWith(t.key)))continue;let e=Number(i.amount??0);H(String(i.category??``))?n+=e:r+=Math.abs(e)}return{label:t.label,sublabel:t.sublabel,key:t.key,income:n,expense:r,net:n-r}})}function xt(){return`
  ...
  `}function St(){let e=G(),t=et(e),n=T.expensesDashTab,r=n===`bank`?e.filter(e=>e.flow_type===`bank`):n===`cash`?e.filter(e=>e.flow_type===`cash`):e,i=Ct(r),a=ct[0];return`
    <p class="eyebrow">Personal Expenses</p>
    ...
    ${N(`home`,`expenses-add`)}
  `}function Ct(e){return R().map(t=>{let n=0,r=0;for(let i of e){if(!(t.isDay?i.date===t.key:String(i.date).startsWith(t.key)))continue;let e=Number(i.amount??0);i.direction===`income`?n+=e:r+=e}return{label:t.label,sublabel:t.sublabel,key:t.key,income:n,expense:r,net:n-r}})}function wt(){return`
  ...
  `}function Et(){return`
    ...
    <button class="btn-secondary" data-back="settings">Back to settings</button>
  `}var Dt=[`CREATE TABLE IF NOT EXISTS bank_transactions (
    ...
    <section class="card"><h3>SQLite schema</h3><p class="sub">${Dt.length} local tables ready for mobile storage.</p></section>
    <button class="btn-secondary" data-back="settings">Back to settings</button>
  `}function kt(){return`
    <p class="eyebrow">Settings</p>
  ...
  `}function Mt(){return`
    ...
    <section class="card settings-panel">
      <div class="settings-version-row"><span>Mobile version</span><b>${ie}</b></div>
    ...
    <button class="btn-secondary" data-back="settings">Back to settings</button>
  `}var Nt=[[`settings-profile`,`Profile`,`Edit your name and profile initials.`,`👤`],[`settings-import-export`,`Import / Export`,`Paste import, Excel import, and Excel export.`,`📥`],[`settings-investment`,`Investment`,`Share portfolio rules and SIP notes.`,`📈`],[`settings-backup-sync`,`Backup & sync`,`Local backup status and future sync entry point.`,`☁`],[`settings-privacy`,`Privacy`,`On-device SQLite storage and data controls.`,`🔒`],[`settings-about`,`About`,`Mobile runtime and desktop/mobile differences.`,`ℹ`],[`settings-how-to-use`,`How To Use`,`Mobile navigation and entry guidance.`,`?`],[`settings-version`,`Version`,`Mobile and desktop release tag details.`,`#`]];function Pt(){return`
    <p class="eyebrow">Settings</p>
    <h1 class="pagehead">General</h1>
    <section class="card settings-menu" style="padding:6px 16px;">
      ${Nt.map(([e,t,n,r])=>Ft(e,t,n,r)).join(``)}
    </section>
  ...
  `}function Y(){return Array.from(new Set(W.map(e=>String(e.share_name??``).trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function It(e,t,n){return`
    <div class="field">
      <label>Share name</label>
      <input type="text" list="${e}" placeholder="${t}" autocomplete="off">
      <datalist id="${e}">
        ${n.map(e=>`<option value="${e}"></option>`).join(``)}
      </datalist>
    </div>`}function Lt(){return Y().filter(e=>W.some(t=>String(t.share_name??``).trim().toUpperCase()===e&&String(t.category??``).toLowerCase()===`ipo`))}function Rt(){return Y().filter(e=>W.some(t=>String(t.share_name??``).trim().toUpperCase()===e&&String(t.category??``).toLowerCase()===`sip`))}function zt(){let e=T.sharesEntryType,t=e===`sip`,n=e===`dividend`,r=e===`buy`||e===`sell`,i=T.sharesDividendType,a=`
    <div class="field">
      <label>Share name</label>
      ...
      <datalist id="mobile-share-name-suggestions">
        ${Y().map(e=>`<option value="${e}"></option>`).join(``)}
      </datalist>
    </div>`;return`
    ...
    <section class="card">
      ...
      ${t?`
        ...
        ${P(`SIP installment amount`,`number`)}
      `:``}
      ...
      ${n?`
        ...
        ${P(i===`cash`?`Amount`:`Number of shares`,`number`)}
      `:``}

      ${!t&&!r&&!n?`
        ${P(`Per unit price`,`number`)}
        ${P(`Allotted`,`number`)}
      `:``}
  ...
  `}function Bt(e){let t=String(e.share_name??``).trim().toUpperCase(),n=String(e.category??``).trim().toLowerCase();n===`dividend`&&(n=String(e.buy_sell??``).trim().toLowerCase()===`bonus`?`dividend (bonus)`:`dividend (cash)`),n===`sip`&&(n=String(e.buy_sell??``).trim().toLowerCase()===`redeem`?`sip (redeem)`:`sip (installment)`);let r=Number(e.allotted??0),i=r>0?` · allotted ${r}`:``;return`${t?`${t} · `:``}${n}${i}`}function Vt(){let e=ot(W),t=Ut(),n=W.map(e=>({description:Bt(e),category:String(e.category??``),amount:Number(e.total_amount),direction:Number(e.profit_loss??0)>=0?`income`:`expense`,flow_type:`shares`,date:e.date}));return`
    ...
    ${z(`Portfolio value trend`,t,[{label:`Share movement`,color:`var(--accent-purple)`}])}
    ...
    <section class="card">
      ...
      ${It(`mobile-ipo-name-suggestions`,`Type IPO share name`,Lt())}
    ...
    <section class="card">
      ...
      ${It(`mobile-sip-name-suggestions`,`Type SIP share name`,Rt())}
    ...
    ${N(`home`,`shares-add`)}
  `}function Ht(){let e=new Map;for(let t of W){let n=String(t.share_name??``).toUpperCase(),r=Number(t.allotted??0);e.set(n,(e.get(n)??0)+(t.buy_sell===`sell`?-r:r))}let t=(T.dashSearchQuery[`shares-portfolio`]??``).toLowerCase(),n=[...e.entries()].filter(([,e])=>e>0).filter(([e])=>!t||e.toLowerCase().includes(t)).sort((e,t)=>e[0].localeCompare(t[0]));return n.length?`<table class="mini">
    <tr><th>Share</th><th style="text-align:right;">Qty remaining</th></tr>
    ${n.map(([e,t])=>`<tr><td>${e}</td><td>${t}</td></tr>`).join(``)}
  </table>`:`<p class="sub">${t?`No shares match your search.`:`No remaining holdings.`}</p>`}function Ut(){return R().map(e=>{let t=W.filter(t=>e.isDay?t.date===e.key:String(t.date).startsWith(e.key)).reduce((e,t)=>e+Math.abs(Number(t.total_amount??0)),0);return{label:e.label,sublabel:e.sublabel,value:t,color:`var(--accent-purple)`}})}function Wt(){let e=Ye(U),t=ot(W),n=et(G()),r=e.net_balance+t.grand_profit_loss+n.combined.overall_net,i=Gt(e.net_balance,t.grand_profit_loss,n.combined.overall_net);return`
    ...
    ${z(`Net worth trend`,i,[{label:`Net ≥ 0`,color:`var(--brand-teal)`},{label:`Net < 0`,color:`var(--accent-amber)`}])}
    ...
    ${N(`home`)}
  `}function Gt(e,t,n){let r=new Date().toISOString().slice(0,10),i=r.slice(0,7);return R().map(a=>{let o=(a.isDay?a.key===r:a.key===i)?e+t+n:0,s=o>=0?`var(--brand-teal)`:`var(--accent-amber)`;return{label:a.label,sublabel:a.sublabel,value:o,color:s}})}function Kt(){return`
  ...
  `}function qt(e,t={}){e!==T.activeScreen&&(t.replace?T.screenHistory[T.screenHistory.length-1]=e:T.screenHistory.push(e)),T.activeScreen=e,Z(),window.scrollTo({top:0})}function X(e=`home`){if(T.activeScreen===`home`){let e=Date.now();if(e-T.lastHomeBackPress<1800){fe();return}T.lastHomeBackPress=e,de(`Press back again to exit`);return}T.screenHistory.pop(),qt(T.screenHistory[T.screenHistory.length-1]||e,{replace:!0})}function Z(){let e=document.querySelector(`#app`);e&&(e.innerHTML=`
    <div class="app-shell">
      ${Pe()}
      ${Fe()}
      ${M(`home`,pt())}
      ...
      ${M(`summary`,Wt())}
      ${M(`settings`,Pt())}
      ${M(`settings-profile`,jt())}
      ${M(`settings-import-export`,Ot())}
      ${M(`settings-investment`,kt())}
      ${M(`settings-backup-sync`,Tt())}
      ${M(`settings-privacy`,At())}
      ${M(`settings-about`,wt())}
      ${M(`settings-how-to-use`,Et())}
      ${M(`settings-version`,Mt())}
    </div>
  `,Jt(),requestAnimationFrame(()=>{document.querySelectorAll(`[data-scroll-end]`).forEach(e=>{e.scrollLeft=e.scrollWidth})}))}function Jt(){document.addEventListener(`focusin`,e=>{let t=e.target;t&&(t.tagName===`INPUT`||t.tagName===`SELECT`||t.tagName===`TEXTAREA`)&&window.setTimeout(()=>$(t),120)}),window.visualViewport?.addEventListener(`resize`,()=>{let e=document.activeElement;if(!e)return;let t=e.tagName;(t===`INPUT`||t===`SELECT`||t===`TEXTAREA`)&&$(e)}),document.querySelector(`[data-open-drawer]`)?.addEventListener(`click`,()=>{document.querySelector(`.drawer`)?.classList.add(`open`),document.querySelector(`.drawer-overlay`)?.classList.add(`open`)}),document.querySelector(`[data-close-drawer]`)?.addEventListener(`click`,Xt),document.querySelectorAll(`[data-nav]`).forEach(e=>{e.addEventListener(`click`,()=>qt(e.dataset.nav))}),document.querySelectorAll(`[data-back]`).forEach(e=>{e.addEventListener(`click`,()=>X(e.dataset.back||`home`))}),document.querySelectorAll(`[data-home-mode]`).forEach(e=>{e.addEventListener(`click`,()=>{T.homeMode=e.dataset.homeMode,T.categorySelectionTouched=!1,Z()})}),document.querySelectorAll(`[data-home-range]`).forEach(e=>{e.addEventListener(`click`,()=>{T.homeRange=e.dataset.homeRange,Z()})}),document.querySelectorAll(`[data-bank-range]`).forEach(e=>{e.addEventListener(`click`,()=>{T.bankRange=e.dataset.bankRange,Z()})}),document.querySelectorAll(`[data-category-check]`).forEach(e=>{e.addEventListener(`change`,Yt)}),document.querySelector(`[data-custom-start]`)?.addEventListener(`change`,e=>{T.customStart=e.target.value||T.customStart,Z()}),document.querySelector(`[data-custom-end]`)?.addEventListener(`change`,e=>{T.customEnd=e.target.value||T.customEnd,Z()}),document.querySelectorAll(`[data-profile-form]`).forEach(e=>{e.addEventListener(`submit`,t=>{t.preventDefault(),le(String(new FormData(e).get(`profileName`)||``)),Z()})}),document.querySelector(`[data-dismiss-profile]`)?.addEventListener(`click`,()=>{ue(),Z()}),document.querySelectorAll(`[data-search-module]`).forEach(e=>{e.addEventListener(`input`,()=>{let t=e.dataset.searchModule??``;t&&(T.dashSearchQuery[t]=e.value.toLowerCase(),Zt(e,t))})}),document.querySelectorAll(`[data-expenses-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{T.expensesDashTab=e.dataset.expensesTab??`combined`,Z()})}),document.querySelectorAll(`[data-shares-entry-type]`).forEach(e=>{e.addEventListener(`change`,()=>{T.sharesEntryType=e.value,Z()})}),document.querySelectorAll(`[data-shares-dividend-type]`).forEach(e=>{e.addEventListener(`change`,()=>{T.sharesDividendType=e.value,Z()})}),document.querySelectorAll(`[data-shares-sip-type]`).forEach(e=>{e.addEventListener(`change`,()=>{T.sharesSipType=e.value,Z()})})}function Yt(e){let t=e.target.value,n=Array.from(document.querySelectorAll(`[data-category-check]`));if(t===`__all__`&&e.target.checked){T.categorySelectionTouched=!1,T.selectedHomeCategories=new Set(q()),Z();return}let r=n.filter(e=>e.value!==`__all__`&&e.checked).map(e=>e.value);r.length?(T.categorySelectionTouched=!0,T.selectedHomeCategories=new Set(r)):(T.categorySelectionTouched=!1,T.selectedHomeCategories=new Set(J())),Z()}function Xt(){document.querySelector(`.drawer`)?.classList.remove(`open`),document.querySelector(`.drawer-overlay`)?.classList.remove(`open`)}var Q;function Zt(e,t){Q!==void 0&&window.clearTimeout(Q),Q=window.setTimeout(()=>{Q=void 0,Z();let e=document.querySelector(`[data-search-module="${t}"]`);if(e){e.focus();try{e.setSelectionRange(e.value.length,e.value.length)}catch{}$(e)}},250)}function $(e){let t=window.visualViewport,n=t&&t.height>0?t.height:window.innerHeight,r=document.scrollingElement||document.documentElement,i=e.getBoundingClientRect();if(i.bottom>n*.7||i.top<0){let e=t&&t.offsetTop||0,a=Math.max(12,Math.round(n*.18))+e;r.scrollTop+=i.top-a}}function Qt(){v.addListener(`backButton`,()=>{if(document.querySelector(`.drawer.open`)){Xt();return}X()}).catch(()=>{window.addEventListener(`popstate`,()=>X())})}Z(),Qt();export{o as t};